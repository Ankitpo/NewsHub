...
async function getTechnologyNews() {
  const response = await fetch(
    "https://newsapi.org/v2/top-headlines?country=us&category=technology&pageSize=12&apiKey=50c25ce81659402cbaca82874d6e10aa",
  );
    ...
    <main>
      ...
      <div className="container py-5">
        <section className="mb-4">
          <h1 className="fw-bold">Technology News</h1>

          <p className="text-muted">
            Stay updated with the latest technology, gadgets, and innovations.
          </p>
        </section>
