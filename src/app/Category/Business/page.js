...
async function getBusinessNews() {
  const response = await fetch(
    "https://newsapi.org/v2/top-headlines?country=us&category=business&pageSize=12&apiKey=50c25ce81659402cbaca82874d6e10aa",
  );
    ...
    <main>
      ...
      <div className="container py-5">
        <section className="mb-4">
          <h1 className="fw-bold">Business News</h1>

          <p className="text-muted">
            Stay updated with the latest business, market, and economic news.
          </p>
        </section>
