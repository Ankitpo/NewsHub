...
async function getWorldNews() {
  const response = await fetch(
    "https://newsapi.org/v2/top-headlines?country=us&category=general&pageSize=12&apiKey=50c25ce81659402cbaca82874d6e10aa",
  );
    ...
    <main>
      ...
      <div className="container py-5">
        <section className="mb-4">
          <h1 className="fw-bold">World News</h1>

          <p className="text-muted">
            Get the latest news and updates from around the world.
          </p>
        </section>
